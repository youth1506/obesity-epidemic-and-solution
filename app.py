...
def predictheart():
    ...
    if output == 1:
        ...
        nutrition_recommendations = "For high-risk patients, it's essential to follow a heart-healthy diet. Consume foods rich in fruits, vegetables, whole grains, lean proteins, and limit saturated fats and cholesterol. Regular exercise is also crucial."
    else:
        res_val = "a low risk of Heart Disease"
        nutrition_recommendations = "Even though you have a low risk, maintaining a balanced diet and regular exercise is important for overall heart health."

    return render_template('heart_result.html', prediction_text='Patient has {}'.format(res_val), nutrition_text=nutrition_recommendations)
